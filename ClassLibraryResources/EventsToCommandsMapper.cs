...
namespace ClassLibraryResources
{
    ...
    public class EventToCommand : Freezable
    {
        ...
        public static readonly DependencyProperty HandledIfExecutedProperty =
            DependencyProperty.Register("HandledIfExecuted", typeof(bool), typeof(EventToCommand),
        ...
        {
            get => (bool) GetValue(HandledIfExecutedProperty);
    ...
    public static class EventsToCommandsMapper
    {
        public static readonly DependencyProperty MapperProperty =
            DependencyProperty.RegisterAttached("Mapper", typeof(EventToCommandCollection),
                typeof(EventsToCommandsMapper),
        ...
        private static void OnMapperChanged(DependencyObject obj, DependencyPropertyChangedEventArgs e)
        {
            ...
            foreach (var evt in eventCollection)
            {
                ...
                eventInfo.AddEventHandler(
                    obj, Delegate.CreateDelegate(eventInfo.EventHandlerType, c,
                        typeof(Closure).GetMethod(nameof(c.EventHandler),
