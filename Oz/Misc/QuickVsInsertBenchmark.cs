...
namespace Oz
{
    public class QuickVsInsertBenchmark
    {
        ...
        private readonly QuickSorter<Data> _quickSorter = new QuickSorter<Data>();
        private readonly ISorter<Data> _randomizedQuickSorter = new QuickSorter<Data>(PartitionStrategy.RandomizedPartition);
        private readonly InsertionSorter<Data> _insertionSorter = new InsertionSorter<Data>();
        ...
        public void QuickDifferentSetup()
        {
            ...
            {
                Key = key,
                Value = _randomSource.RandomDouble
            }).ToArray());
        }
