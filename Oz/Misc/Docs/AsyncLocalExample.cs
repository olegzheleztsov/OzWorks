...
namespace Oz.Misc.Docs
{
    ...
    {
        private static AsyncLocal<string> _asyncLocalString = new();
        private static ThreadLocal<string> _threadLocalString = new();
        ...
        private static async Task AsyncMethodB(string expectedValue)
        {
            ...
            WriteLine($"  Expected '{expectedValue}', got '{_asyncLocalString.Value}', ThreadLocal value is '{_threadLocalString.Value}'");
        }
